...
def create_conv_net(x, keep_prob, channels, n_class, layers=3, features_root=16, filter_size=3, pool_size=2, summaries=True):
    ...
    tf.summary.image('output_map0', get_image_summary(output_map,0))
    tf.summary.image('output_map1', get_image_summary(output_map,1))
...
class Trainer(object):
    ...
    def _initialize(self, training_iters, output_path, restore, prediction_path):
        ...
        #tf.summary.scalar('momentum', self.optimizer.)
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.75, display_step=1, restore=False, write_graph=False, prediction_path = 'prediction'):
        ...
        with tf.Session() as sess:
            ...
            test_x, test_y = data_provider(self.verification_batch_size, 'valid')
            pred_shape = self.store_prediction(sess, test_x, test_y, "_init")
            
            print('FileWriter output_path', output_path)
            ...
            for epoch in range(epochs):
                ...
                for step in range((epoch*training_iters), ((epoch+1)*training_iters)):
                    ...
                    batch_x, batch_y = data_provider(self.batch_size, 'train')
