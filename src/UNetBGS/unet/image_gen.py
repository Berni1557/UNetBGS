...
def create_image_and_label(nx,ny, cnt = 10, r_min = 5, r_max = 50, border = 92, sigma = 20, rectangles=False):
    ...
    #cv2.imwrite('H:/cloud/cloud_data/Projects/TensorFlow/unet/unet/color_img.jpg', image)
    
    #scipy.misc.imsave('H:/cloud/cloud_data/Projects/TensorFlow/unet/unet/color_img.jpg', image)
    ...
    #print('label1 shape', label.shape)
    #print('label1 type', label.dtype)
